...
(() => {
    ...
    var require_object_property_is_enumerable = __commonJS({
        "node_modules/core-js/internals/object-property-is-enumerable.js"(exports) {
            ...
            var NASHORN_BUG =
                getOwnPropertyDescriptor && !$propertyIsEnumerable.call({
                    1: 2
                }, 1);
    ...
    var require_compose = __commonJS({
        "node_modules/redux/lib/compose.js"(exports) {
            ...
            function compose() {
                for (
                    var _len = arguments.length, funcs = Array(_len), _key = 0; _key < _len; _key++
                ) {
    ...
    var require_applyMiddleware = __commonJS({
        "node_modules/redux/lib/applyMiddleware.js"(exports) {
            ...
            function applyMiddleware() {
                for (
                    var _len = arguments.length, middlewares = Array(_len), _key = 0; _key < _len; _key++
                ) {
        ...
        "packages/systems/ix2/engine/logic/IX2VanillaEngine.js"(exports) {
            ...
            function createGroupInstances({
                ...
                instanceConfigs.forEach(({
                    ...
                    const pluginInstance = isPluginType(actionTypeId) ? // $FlowFixMe
                ...
                if (actionList && actionList.useFirstGroupAsInitialState) {
                    ...
                    initialStateItems.forEach((actionItem) => {
                        ...
                        itemElements.forEach((element) => {
                            const pluginInstance = shouldUsePlugin ? // $FlowFixMe
                                createPluginInstance(actionTypeId)(element, actionItem) :
                                null;
                            createInstance({
                ...
                actionItems.forEach((actionItem, actionIndex) => {
                    ...
                    elements.forEach((element, elementIndex) => {
                        const pluginInstance = shouldUsePlugin ? // $FlowFixMe
                            createPluginInstance(actionTypeId)(element, actionItem) :
                            null;
                        const pluginDuration = shouldUsePlugin ? // $FlowFixMe
...
Webflow.require("ix").init([{
    ...
    {
        slug: "fade-in-bottom-long-scroll-in",
        name: "Fade in bottom long (scroll in)",
        value: {
            style: {
                opacity: 1,
                x: "0px",
    ...
    {
        slug: "fade-in-scroll-league-2",
        name: "Fade in scroll league 2",
        value: {
            style: {},
            triggers: [{
                type: "scroll",
    ...
    },
    {
        ...
        value: {
            ...
            triggers: [{
                    ...
                    stepsB: [{
                        opacity: 1,
                        transition: "transform 1000ms ease 0, opacity 100ms ease 0",
                    }, ],
                },
                {
                    type: "load",
    ...
    {
        slug: "opacity-100-on-hover",
        name: "Opacity 100 on hover",
        value: {
            style: {
                opacity: 0
            },
